...
public class ReservationDaoImpl implements ReservationDao {
    ...
    public boolean addReservation(Reservation r) {
        ...
        try (PreparedStatement ps = conn.prepareStatement(sql)) {
            // === SAFETY DEFAULTS ===
            ps.setString(1, r.getCustomerName() != null ? r.getCustomerName() : "Guest");
            ps.setString(2, r.getContact() != null ? r.getContact() : "N/A");
            ...
            // Guarantee unique reference ID
            String refId = (r.getReferenceId() != null && !r.getReferenceId().isEmpty())
                    ? r.getReferenceId()
            ...
            System.out.println(" Reservation inserted successfully (rows=" + rows + ")");
            return rows > 0;

        } catch (SQLException e) {
            System.err.println(" SQL Error adding reservation: " + e.getMessage());
            e.printStackTrace();
            return false;
        }
    }
