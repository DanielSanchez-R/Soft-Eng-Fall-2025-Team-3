...
public class DBConnection {
    ...
    public static synchronized Connection getConnection() {
        try {
            // Resolve path relative to the deployed web application root
            // Always points to /data/restaurantdb inside project or exploded WAR
            String basePath = new File("data/restaurantdb").getAbsolutePath();
