...
<head>
    <meta charset="UTF-8">
    <title>Create Reservation - Pizzas 505 ENMU</title>
    <style>
...
<div class="container">
    ...
    <form action="customerReservation" method="post" onsubmit="return validateForm()">
            ...
            <div class="table-selector">
                ...
                <label class="table-option">
                    <input type="radio" name="tableId" value="<%= table.getId() %>"
                           onchange="updateTableSelection()" required>
        ...
        <div class="pricing-info">
            <strong>💡 Note:</strong> Table pricing shown includes base reservation fee and any applicable zone surcharges.
            <br><small>Cancellations must be made at least 2 hours before your reservation time.</small>
        </div>
