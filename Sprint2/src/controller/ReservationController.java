...
public class ReservationController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        //  Normalize parameters: accept both ?action= and ?view= from adminDashboard
        String action = req.getParameter("action");
        String view = req.getParameter("view");
        if ((action == null || action.isEmpty()) && (view != null && !view.isEmpty())) {
            action = view; // handle adminDashboard.jsp links using ?view=staff
        }
        ...
        try {
            ...
            switch (action) {
                ...
                //  Handle adminDashboard button “view=staff” explicitly
                case "staff":
    ...
    private void deleteReservation(HttpServletRequest req, HttpServletResponse resp,
        ...
        if (success) {
            System.out.println(" Deleted reservation ID: " + deleteId);
        } else {
