Project Title PS04: 505 Pizzas Simple overview of use/purpose. (FINAL)
...
Getting Started HOW TO OPERATE – OUT OF THE BOX GUIDE ###Prerequisites####
...
Apache Ant (Build Tool) Apache Ant version 1.9.15
Verify installation:

ant -version

Bundled Apache Tomcat 7
...
Navigate into the project folder: Example: (where your foldeer is located): cd "path\to\Fall2025Project"
...
Email: admin@restaurant.com Password: 1234

Email: customer@restaurant.com Password: 1234
